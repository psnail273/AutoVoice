  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-full p-6 bg-gradient-to-br from-background via-background to-muted/30">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-4 right-4 w-24 h-24 rounded-full bg-accent/10 blur-3xl" />
        <div className="absolute bottom-4 left-4 w-28 h-28 rounded-full bg-primary/10 blur-3xl" />
      </div>
